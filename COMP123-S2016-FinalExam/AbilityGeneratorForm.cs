...
namespace COMP123_M2020_FinalExam
{
    public partial class AbilityGeneratorForm : Form
    {
        ...
        private TextBox m_firstAbility;
        private TextBox m_secondAbility;
        private TextBox m_modifiedAbility;
        ...
        private Int32 Roll()
        {
            ...
            {
                int generatedNumber = this.m_random.Next(0, 6) + 1;
        ...
        private void SwapButton_Click(object sender, EventArgs e)
        {
            ...
            temporaryAbility = this.m_firstAbility.Text;
            this.m_firstAbility.Text = this.m_secondAbility.Text;
            this.m_secondAbility.Text = temporaryAbility;
        }
        ...
        private void FirstAbilityComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            this.m_firstAbility = ChooseAbility(FirstAbilityComboBox.SelectedIndex);
        }

        private void SecondAbilityComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            // make a reference to the first ability selected
            this.m_secondAbility = ChooseAbility(SecondAbilityComboBox.SelectedIndex);
        }
        ...
        private void ModifyComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            this.m_modifiedAbility = ChooseAbility(ModifyComboBox.SelectedIndex);
        }

        private void ModifyButton_Click(object sender, EventArgs e)
        {
            int ScoreToModify = Convert.ToInt32(this.m_modifiedAbility.Text);
            ScoreToModify += 1;
            this.m_modifiedAbility.Text = ScoreToModify.ToString();
